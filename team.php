        ...
        <div class="container container-fluid">
          <div class="row justify-content-around">
            <div class="col col-xl-4 text-center p-4">
              ...
              <h3 class="pt-1 ps-5">Swarnim Raj</h3>
              <h4 class="pt-1 ps-5">Team Leader</h4>
            </div>
            <div class="col col-xl-4 text-center p-4">
              <div class="media mx-auto">
                <img
              ...
              <h3 class="pt-1 ps-5">Keshav Bagri</h3>
              <h4 class="pt-1 ps-5">Deputy Team Leader</h4>
            </div>
            <div class="col col-xl-4 text-center p-4">
              <div class="media mx-auto">
                <img
              ...
              <h3 class="pt-1 ps-5">Vasu Chourasia</h3>
              <h4 class="pt-1 ps-5">Finance Head</h4>
            </div>
          </div>
        </div>
        ...
        <div class="container container-fluid">
          <div class="row justify-content-around">
            <div class="col col-xl-6 text-center p-4">
              ...
              <h3 class="pt-1 ps-5">Moinak Ghosh</h3>
              <h4 class="pt-1 ps-5">CPR Head</h4>
            </div>
            <div class="col col-xl-6 text-center p-4">
              <div class="media mx-auto">
                <img
              ...
              <h3 class="pt-1 ps-5">Arya Tathe</h3>
              <h4 class="pt-1 ps-5">Media Head</h4>
            </div>
          </div>
        </div>
        <!-- Drivetrain -->
        ...
        <div class="container container-fluid">
          <div class="row justify-content-around">
            <div class="col col-xl-12 text-center p-4">
              ...
              <h3 class="pt-1 ps-5">Amar Bapat</h3>
              <h4 class="pt-1 ps-5">Powertrain Head</h4>
            </div>
          </div>
        </div>
        <!-- Electronics -->
        ...
        <div class="container container-fluid">
          <div class="row justify-content-around">
            <div class="col col-xl-4 text-center p-4">
              ...
              <h3 class="pt-1 ps-5">Sumedh Lodhi</h3>
              <h4 class="pt-1 ps-5">EV Head</h4>
            </div>
            <div class="col col-xl-4 text-center p-4">
              <div class="media mx-auto">
                <img
              ...
              <h3 class="pt-1 ps-5">Gaurav Bisen</h3>
              <h4 class="pt-1 ps-5">Electronics Head</h4>
            </div>
            <div class="col col-xl-4 text-center p-4">
              <div class="media mx-auto">
                <img
              ...
              <h3 class="pt-1 ps-5">Siddharth Porwal</h3>
              <h4 class="pt-1 ps-5">Electronics Head</h4>
            </div>
          </div>
        </div>
        ...
        <div class="container-fluid">
          <div class="row justify-content-between">
            <div class="col col-xl-3 text-center p-4">
              ...
              <h3 class="pt-1 ps-5">Vardhan Vydula</h3>
              <h4 class="pt-1 ps-5">Aerodynamics Head</h4>
            </div>
            <div class="col col-xl-3 text-center p-4">
              <div class="media mx-auto">
                <img
              ...
              <h3 class="pt-1 ps-5">Utsab Pal</h3>
              <h4 class="pt-1 ps-5">Aerodynamics Head</h4>
            </div>
            <div class="col col-xl-3 text-center p-4">
              <div class="media mx-auto">
              ...
              <h3 class="pt-1 ps-5">Subhadeep Mondal</h3>
              <h4 class="pt-1 ps-5">Aerodynamics Head</h4>
            </div>
            <div class="col col-xl-3 text-center p-4">
              <div class="media mx-auto">
              ...
              <h3 class="pt-1 ps-5">Pankaj Sethi</h3>
              <h4 class="pt-1 ps-5">Aerodynamics Head</h4>
            </div>
          </div>
        </div>
        ...
        <div class="container container-fluid">
          <div class="row justify-content-around">
            <div class="col col-xl-6 text-center p-4">
              ...
              <h3 class="pt-1 ps-5">Sudhanshu Shankar</h3>
              <h4 class="pt-1 ps-5">Suspension & Brakes Head</h4>
            </div>
            <div class="col col-xl-6 text-center p-4">
              <div class="media mx-auto">
                <img
              ...
              <h3 class="pt-1 ps-5">Shivansh Laad</h3>
              <h4 class="pt-1 ps-5">Chassis Head</h4>
            </div>
          </div>
        </div>
      </div>
